$_mod.def("/marko$4.2.8/components/init-components-browser", function(require, exports, module, __filename, __dirname) { 'use strict';
...
var ComponentDef = require('/marko$4.2.8/components/ComponentDef'/*'./ComponentDef'*/);
