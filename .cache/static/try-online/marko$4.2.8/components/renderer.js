$_mod.def("/marko$4.2.8/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.2.8/components/util-browser'/*'./util'*/);
var componentLookup = componentsUtil.$__componentLookup;
var emitLifecycleEvent = componentsUtil.$__emitLifecycleEvent;

var ComponentsContext = require('/marko$4.2.8/components/ComponentsContext'/*'./ComponentsContext'*/);
var getComponentsContext = ComponentsContext.$__getComponentsContext;

var nextRepeatedId = require('/marko$4.2.8/components/nextRepeatedId'/*'./nextRepeatedId'*/);
var repeatedRegExp = /\[\]$/;
var registry = require('/marko$4.2.8/components/registry-browser'/*'./registry'*/);
