$_mod.def("/onigurumajs$1.0.0/index", function(require, exports, module, __filename, __dirname) { var _ = require('/lodash$3.10.1/index'/*'lodash'*/)
var xregexp = require('/xregexp$3.2.0/xregexp-all'/*'xregexp'*/)
require('/onigurumajs$1.0.0/lib/xregexp-lookbehind'/*'./lib/xregexp-lookbehind'*/)(xregexp)
require('/onigurumajs$1.0.0/lib/xregexp-xescape'/*'./lib/xregexp-xescape'*/)(xregexp)
