$_mod.def("/underscore-plus$1.6.6/lib/underscore-plus", function(require, exports, module, __filename, __dirname) { var process=require("process"); (function() {
  var isEqual, isPlainObject, macModifierKeyMap, nonMacModifierKeyMap, plus, shiftKeyMap, splitKeyPath, _,
    __slice = [].slice;

  _ = require('/underscore$1.6.0/underscore'/*'underscore'*/);
