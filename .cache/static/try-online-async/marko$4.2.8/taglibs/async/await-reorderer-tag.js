$_mod.def("/marko$4.2.8/taglibs/async/await-reorderer-tag", function(require, exports, module, __filename, __dirname) { 'use strict';

const clientReorder = require('/marko$4.2.8/taglibs/async/client-reorder-browser'/*'./client-reorder'*/);
