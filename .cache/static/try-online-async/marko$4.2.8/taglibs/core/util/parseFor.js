$_mod.def("/marko$4.2.8/taglibs/core/util/parseFor", function(require, exports, module, __filename, __dirname) { 'use strict';
var removeComments = require('/marko$4.2.8/compiler/util/removeComments'/*'../../../compiler/util/removeComments'*/);
var compiler = require('/marko$4.2.8/compiler/index'/*'../../../compiler'*/);

var integerRegExp = /^-?\d+$/;
var numberRegExp = /^-?(?:\d+|\d+\.\d*|\d*\.\d+|\d+\.\d+)$/;

var tokenizer = require('/marko$4.2.8/compiler/util/tokenizer'/*'../../../compiler/util/tokenizer'*/).create([
    {
        name: 'stringDouble',
        pattern: /"(?:[^"]|\\")*"/,
    },
