$_mod.def("/marko$4.2.8/compiler/util/removeComments", function(require, exports, module, __filename, __dirname) { 'use strict';
var tokenizer = require('/marko$4.2.8/compiler/util/tokenizer'/*'./tokenizer'*/).create([
    {
        name: 'stringDouble',
        pattern: /"(?:[^"]|\\")*"/,
    },
