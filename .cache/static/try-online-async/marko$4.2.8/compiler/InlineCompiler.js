$_mod.def("/marko$4.2.8/compiler/InlineCompiler", function(require, exports, module, __filename, __dirname) { 'use strict';

let CodeWriter = require('/marko$4.2.8/compiler/CodeWriter'/*'./CodeWriter'*/);
