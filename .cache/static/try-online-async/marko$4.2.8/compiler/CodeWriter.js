$_mod.def("/marko$4.2.8/compiler/CodeWriter", function(require, exports, module, __filename, __dirname) { 'use strict';
...
const Comment = require('/marko$4.2.8/compiler/ast/Comment'/*'./ast/Comment'*/);
const isValidJavaScriptVarName = require('/marko$4.2.8/compiler/util/isValidJavaScriptVarName'/*'./util/isValidJavaScriptVarName'*/);
