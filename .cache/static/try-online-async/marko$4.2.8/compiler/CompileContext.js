$_mod.def("/marko$4.2.8/compiler/CompileContext", function(require, exports, module, __filename, __dirname) { 'use strict';var process=require("process"); 
...
var UniqueVars = require('/marko$4.2.8/compiler/util/UniqueVars'/*'./util/UniqueVars'*/);
var PosInfo = require('/marko$4.2.8/compiler/util/PosInfo'/*'./util/PosInfo'*/);
var CompileError = require('/marko$4.2.8/compiler/CompileError'/*'./CompileError'*/);
var path = require('/path-browserify$0.0.0/index'/*'path'*/);
var Node = require('/marko$4.2.8/compiler/ast/Node'/*'./ast/Node'*/);
var macros = require('/marko$4.2.8/compiler/util/macros'/*'./util/macros'*/);
...
var utilFingerprint = require('/marko$4.2.8/compiler/util/finger-print'/*'./util/finger-print'*/);
var htmlElements = require('/marko$4.2.8/compiler/util/html-elements'/*'./util/html-elements'*/);
var markoModules = require('/marko$4.2.8/compiler/modules'/*'./modules'*/);

const markoPkgVersion = require('/marko$4.2.8/package'/*'../package.json'*/).version;
...
CompileContext.prototype.util = {
    isValidJavaScriptIdentifier: require('/marko$4.2.8/compiler/util/isValidJavaScriptIdentifier'/*'./util/isValidJavaScriptIdentifier'*/),
    isJavaScriptReservedWord: require('/marko$4.2.8/compiler/util/isJavaScriptReservedWord'/*'./util/isJavaScriptReservedWord'*/)
};
