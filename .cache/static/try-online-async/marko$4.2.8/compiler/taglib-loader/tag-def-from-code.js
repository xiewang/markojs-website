$_mod.def("/marko$4.2.8/compiler/taglib-loader/tag-def-from-code", function(require, exports, module, __filename, __dirname) { // Rather than using a full-blown JavaScript parser, we are going to use a few regular expressions
