$_mod.def("/marko$4.2.8/compiler/taglib-loader/scanTagsDir", function(require, exports, module, __filename, __dirname) { 'use strict';

const nodePath = require('/path-browserify$0.0.0/index'/*'path'*/);
const fs = require('/markojs-website$1.0.0/browser-shims/fs/index'/*'fs'*/);
const stripJsonComments = require('/strip-json-comments$2.0.1/index'/*'strip-json-comments'*/);
const tagDefFromCode = require('/marko$4.2.8/compiler/taglib-loader/tag-def-from-code'/*'./tag-def-from-code'*/);
const loaders = require('/marko$4.2.8/compiler/taglib-loader/loaders'/*'./loaders'*/);
const fsReadOptions = { encoding: 'utf8' };
const extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
const types = require('/marko$4.2.8/compiler/taglib-loader/types'/*'./types'*/);
