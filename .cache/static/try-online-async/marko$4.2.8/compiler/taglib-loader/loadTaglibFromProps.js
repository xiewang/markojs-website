$_mod.def("/marko$4.2.8/compiler/taglib-loader/loadTaglibFromProps", function(require, exports, module, __filename, __dirname) { 'use strict';
...
var scanTagsDir = require('/marko$4.2.8/compiler/taglib-loader/scanTagsDir'/*'./scanTagsDir'*/);
var markoModules = require('/marko$4.2.8/compiler/modules'/*'../modules'*/); // NOTE: different implementation for browser
var propertyHandlers = require('/property-handlers$1.1.1/lib/index'/*'property-handlers'*/);
var types = require('/marko$4.2.8/compiler/taglib-loader/types'/*'./types'*/);
var jsonFileReader = require('/marko$4.2.8/compiler/taglib-loader/json-file-reader'/*'./json-file-reader'*/);
...
var createError = require('/raptor-util$3.2.0/createError'/*'raptor-util/createError'*/);
