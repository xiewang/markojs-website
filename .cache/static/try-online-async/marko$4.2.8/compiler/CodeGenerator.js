$_mod.def("/marko$4.2.8/compiler/CodeGenerator", function(require, exports, module, __filename, __dirname) { 'use strict';

const isArray = Array.isArray;
const Node = require('/marko$4.2.8/compiler/ast/Node'/*'./ast/Node'*/);
const Literal = require('/marko$4.2.8/compiler/ast/Literal'/*'./ast/Literal'*/);
const Identifier = require('/marko$4.2.8/compiler/ast/Identifier'/*'./ast/Identifier'*/);
const HtmlElement = require('/marko$4.2.8/compiler/ast/HtmlElement/index'/*'./ast/HtmlElement'*/);
const Html = require('/marko$4.2.8/compiler/ast/Html'/*'./ast/Html'*/);
const ok = require('/assert$1.4.1/assert'/*'assert'*/).ok;
const Container = require('/marko$4.2.8/compiler/ast/Container'/*'./ast/Container'*/);
const createError = require('/raptor-util$3.2.0/createError'/*'raptor-util/createError'*/);
