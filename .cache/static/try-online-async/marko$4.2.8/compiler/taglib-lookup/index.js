$_mod.def("/marko$4.2.8/compiler/taglib-lookup/index", function(require, exports, module, __filename, __dirname) { 'use strict';
...
taglibLoader = require('/marko$4.2.8/compiler/taglib-loader/index'/*'../taglib-loader'*/);
taglibFinder = require('/marko$4.2.8/compiler/taglib-finder/index'/*'../taglib-finder'*/);
TaglibLookup = require('/marko$4.2.8/compiler/taglib-lookup/TaglibLookup'/*'./TaglibLookup'*/);
});