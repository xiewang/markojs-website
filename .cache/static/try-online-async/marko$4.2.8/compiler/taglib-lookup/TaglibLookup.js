$_mod.def("/marko$4.2.8/compiler/taglib-lookup/TaglibLookup", function(require, exports, module, __filename, __dirname) { 'use strict';

var ok = require('/assert$1.4.1/assert'/*'assert'*/).ok;
var taglibTypes = require('/marko$4.2.8/compiler/taglib-loader/types'/*'../taglib-loader/types'*/);
