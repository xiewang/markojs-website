$_mod.def("/marko$4.2.8/compiler/Compiler", function(require, exports, module, __filename, __dirname) { 'use strict';
var ok = require('/assert$1.4.1/assert'/*'assert'*/).ok;
var path = require('/path-browserify$0.0.0/index'/*'path'*/);
var CodeGenerator = require('/marko$4.2.8/compiler/CodeGenerator'/*'./CodeGenerator'*/);
var CodeWriter = require('/marko$4.2.8/compiler/CodeWriter'/*'./CodeWriter'*/);
var createError = require('/raptor-util$3.2.0/createError'/*'raptor-util/createError'*/);
var resolveDep = require('/marko$4.2.8/runtime/dependencies/index'/*'../runtime/dependencies'*/).resolveDep;
