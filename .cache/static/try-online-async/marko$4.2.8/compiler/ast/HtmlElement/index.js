$_mod.def("/marko$4.2.8/compiler/ast/HtmlElement/index", function(require, exports, module, __filename, __dirname) { 'use strict';

var Node = require('/marko$4.2.8/compiler/ast/Node'/*'../Node'*/);
var Literal = require('/marko$4.2.8/compiler/ast/Literal'/*'../Literal'*/);
var HtmlAttributeCollection = require('/marko$4.2.8/compiler/ast/HtmlAttributeCollection'/*'../HtmlAttributeCollection'*/);
var generateHTMLCode = require('/marko$4.2.8/compiler/ast/HtmlElement/html/generateCode'/*'./html/generateCode'*/);
var generateVDOMCode = require('/marko$4.2.8/compiler/ast/HtmlElement/vdom/generateCode'/*'./vdom/generateCode'*/);
