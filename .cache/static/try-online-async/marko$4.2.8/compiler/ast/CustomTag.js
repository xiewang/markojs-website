$_mod.def("/marko$4.2.8/compiler/ast/CustomTag", function(require, exports, module, __filename, __dirname) { 'use strict';

var HtmlElement = require('/marko$4.2.8/compiler/ast/HtmlElement/index'/*'./HtmlElement'*/);
var removeDashes = require('/marko$4.2.8/compiler/util/removeDashes'/*'../util/removeDashes'*/);
var safeVarName = require('/marko$4.2.8/compiler/util/safeVarName'/*'../util/safeVarName'*/);
