$_mod.def("/marko$4.2.8/compiler/ast/Text/vdom/TextVDOM", function(require, exports, module, __filename, __dirname) { 'use strict';

const Node = require('/marko$4.2.8/compiler/ast/Node'/*'../../Node'*/);
const Literal = require('/marko$4.2.8/compiler/ast/Literal'/*'../../Literal'*/);
const vdomUtil = require('/marko$4.2.8/compiler/util/vdom/index'/*'../../../util/vdom'*/);
