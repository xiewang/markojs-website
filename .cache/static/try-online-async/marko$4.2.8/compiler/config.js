$_mod.def("/marko$4.2.8/compiler/config", function(require, exports, module, __filename, __dirname) { var process=require("process"); var NODE_ENV = process.env.NODE_ENV;
var config;
