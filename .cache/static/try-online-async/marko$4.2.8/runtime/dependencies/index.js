$_mod.def("/marko$4.2.8/runtime/dependencies/index", function(require, exports, module, __filename, __dirname) { var process=require("process"); var path = require('/path-browserify$0.0.0/index'/*'path'*/);
var defaultResolveFrom = require('/resolve-from$2.0.0/index'/*'resolve-from'*/);
