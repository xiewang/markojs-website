$_mod.def("/marko$4.2.8/runtime/html/helpers", function(require, exports, module, __filename, __dirname) { 'use strict';
var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);

var STYLE_ATTR = 'style';
var CLASS_ATTR = 'class';

var escape = require('/marko$4.2.8/runtime/html/escape'/*'./escape'*/);
var escapeXml = escape.escapeXml;
var escapeXmlAttr = escape.escapeXmlAttr;
var attrHelper = require('/marko$4.2.8/runtime/html/helper-attr'/*'./helper-attr'*/);
...
var commonHelpers = require('/marko$4.2.8/runtime/helpers'/*'../helpers'*/);
