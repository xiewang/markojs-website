$_mod.def("/marko$4.2.8/runtime/html/AsyncStream", function(require, exports, module, __filename, __dirname) { 'use strict';var process=require("process"); 
var EventEmitter = require('/events-light$1.0.5/src/index'/*'events-light'*/);
var StringWriter = require('/marko$4.2.8/runtime/html/StringWriter'/*'./StringWriter'*/);
var BufferedWriter = require('/marko$4.2.8/runtime/html/BufferedWriter'/*'./BufferedWriter'*/);
var defaultDocument = typeof document != 'undefined' && document;
var RenderResult = require('/marko$4.2.8/runtime/RenderResult'/*'../RenderResult'*/);
var attrsHelper = require('/marko$4.2.8/runtime/html/helper-attrs'/*'./helper-attrs'*/);
var escapeXml = require('/marko$4.2.8/runtime/html/escape'/*'./escape'*/).escapeXml;
