$_mod.def("/marko$4.2.8/components/taglib/TransformHelper/handleComponentEvents", function(require, exports, module, __filename, __dirname) { 'use strict';

var ATTACH_DETACH_KEY = Symbol('attach-detach');

var bubbleEventsLookup = {};

require('/marko$4.2.8/components/bubble'/*'../../bubble'*/).forEach(function(eventType) {
