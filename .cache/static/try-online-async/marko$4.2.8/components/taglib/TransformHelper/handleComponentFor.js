$_mod.def("/marko$4.2.8/components/taglib/TransformHelper/handleComponentFor", function(require, exports, module, __filename, __dirname) { module.exports = function handleComponentFor() {
    var el = this.el;
