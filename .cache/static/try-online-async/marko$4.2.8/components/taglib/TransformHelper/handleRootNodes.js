$_mod.def("/marko$4.2.8/components/taglib/TransformHelper/handleRootNodes", function(require, exports, module, __filename, __dirname) { 'use strict';

var path = require('/path-browserify$0.0.0/index'/*'path'*/);
var getComponentFiles = require('/marko$4.2.8/components/taglib/TransformHelper/getComponentFiles'/*'./getComponentFiles'*/);
