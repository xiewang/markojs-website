$_mod.def("/marko$4.2.8/components/attach-detach", function(require, exports, module, __filename, __dirname) { var eventDelegation = require('/marko$4.2.8/components/event-delegation'/*'./event-delegation'*/);
