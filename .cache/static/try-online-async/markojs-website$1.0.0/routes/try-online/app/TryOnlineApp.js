...
require('/marko$4.2.8/runtime/dependencies/vdom'/*'marko/runtime/dependencies/vdom'*/);

const vfs = require('/markojs-website$1.0.0/browser-shims/fs/index'/*'~/browser-shims/fs'*/);
const vmodules = require('/markojs-website$1.0.0/routes/try-online/app/vmodules'/*'./vmodules'*/);
const readVirtualFiles = ({})/*require('./readVirtualFiles')*/;
const path = require('/path-browserify$0.0.0/index'/*'path'*/);
const EventEmitter = require('/events-light$1.0.5/src/index'/*'events-light'*/);
