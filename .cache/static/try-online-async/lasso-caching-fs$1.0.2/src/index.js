$_mod.def("/lasso-caching-fs$1.0.2/src/index", function(require, exports, module, __filename, __dirname) { var fs = require('/markojs-website$1.0.0/browser-shims/fs/index'/*'fs'*/);
