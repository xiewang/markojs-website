$_mod.def("/htmljs-parser$2.3.2/Parser", function(require, exports, module, __filename, __dirname) { 'use strict';
var BaseParser = require('/htmljs-parser$2.3.2/BaseParser'/*'./BaseParser'*/);
var operators = require('/htmljs-parser$2.3.2/operators'/*'./operators'*/);
var notifyUtil = require('/htmljs-parser$2.3.2/notify-util'/*'./notify-util'*/);
...
const htmlTags = require('/htmljs-parser$2.3.2/html-tags'/*'./html-tags'*/);
