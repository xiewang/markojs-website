$_mod.def("/event-kit$2.3.0/lib/composite-disposable", function(require, exports, module, __filename, __dirname) { (function() {
  ...
  assertDisposable = function(disposable) {
    if (Disposable == null) {
      Disposable = require('/event-kit$2.3.0/lib/disposable'/*'./disposable'*/);
    }
