$_mod.def("/@pnidem/first-mate$6.2.1/lib/grammar-registry", function(require, exports, module, __filename, __dirname) { (function() {
  ...
  _ref = require('/event-kit$2.3.0/lib/event-kit'/*'event-kit'*/), Emitter = _ref.Emitter, Disposable = _ref.Disposable;

  Grim = ({})/*require('grim')*/;

  Grammar = require('/@pnidem/first-mate$6.2.1/lib/grammar'/*'./grammar'*/);

  NullGrammar = require('/@pnidem/first-mate$6.2.1/lib/null-grammar'/*'./null-grammar'*/);
