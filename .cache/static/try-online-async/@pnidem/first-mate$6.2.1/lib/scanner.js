$_mod.def("/@pnidem/first-mate$6.2.1/lib/scanner", function(require, exports, module, __filename, __dirname) { (function() {
  var OnigScanner, Scanner;

  OnigScanner = require('/onigurumajs$1.0.0/index'/*'oniguruma'*/).OnigScanner;
