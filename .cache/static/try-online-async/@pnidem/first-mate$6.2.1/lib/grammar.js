$_mod.def("/@pnidem/first-mate$6.2.1/lib/grammar", function(require, exports, module, __filename, __dirname) { (function() {
  ...
  _ = require('/underscore-plus$1.6.6/lib/underscore-plus'/*'underscore-plus'*/);

  fs = ({})/*require('fs-plus')*/;

  OnigRegExp = require('/onigurumajs$1.0.0/index'/*'oniguruma'*/).OnigRegExp;

  Emitter = require('/event-kit$2.3.0/lib/event-kit'/*'event-kit'*/).Emitter;

  Grim = ({})/*require('grim')*/;

  Injections = require('/@pnidem/first-mate$6.2.1/lib/injections'/*'./injections'*/);

  Pattern = require('/@pnidem/first-mate$6.2.1/lib/pattern'/*'./pattern'*/);

  Rule = require('/@pnidem/first-mate$6.2.1/lib/rule'/*'./rule'*/);

  ScopeSelector = require('/@pnidem/first-mate$6.2.1/lib/scope-selector'/*'./scope-selector'*/);
