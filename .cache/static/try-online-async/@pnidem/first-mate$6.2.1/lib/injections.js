$_mod.def("/@pnidem/first-mate$6.2.1/lib/injections", function(require, exports, module, __filename, __dirname) { (function() {
  var Injections, Scanner, ScopeSelector, _;

  _ = require('/underscore-plus$1.6.6/lib/underscore-plus'/*'underscore-plus'*/);

  Scanner = require('/@pnidem/first-mate$6.2.1/lib/scanner'/*'./scanner'*/);
