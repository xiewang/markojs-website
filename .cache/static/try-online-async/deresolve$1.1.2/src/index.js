$_mod.def("/deresolve$1.1.2/src/index", function(require, exports, module, __filename, __dirname) { require('/raptor-polyfill$1.0.2/string/startsWith'/*'raptor-polyfill/string/startsWith'*/);
require('/raptor-polyfill$1.0.2/string/endsWith'/*'raptor-polyfill/string/endsWith'*/);

var lassoProjectRoot = require('/lasso-package-root$1.0.1/src/index'/*'lasso-package-root'*/);
var resolveFrom = require('/resolve-from$1.0.1/index'/*'resolve-from'*/);
