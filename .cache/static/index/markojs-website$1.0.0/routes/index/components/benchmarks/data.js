$_mod.def("/markojs-website$1.0.0/routes/index/components/benchmarks/data", function(require, exports, module, __filename, __dirname) { const libraries = {
    inferno: {
        name:'Inferno',
        logo:require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/inferno.png'/*'./logos/inferno.png'*/),
        color:'#e60022'
    },
    marko: {
        name:'Marko',
        logo:require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/marko.png'/*'./logos/marko.png'*/),
        color:'#d04'
    },
    preact: {
        name:'Preact',
        logo:require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/preact.png'/*'./logos/preact.png'*/),
        color: '#673ab8'
    },
    react: {
        name:'React',
        logo:require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/react.jpg'/*'./logos/react.jpg'*/),
        color:'#61dafb'
    },
    vue: {
        name:'Vue',
        logo:require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/vue.png'/*'./logos/vue.png'*/),
        color:'#4fc08d'
    }
};
...
const environments = {
    node: {
        logo: require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/node.jpg'/*'./logos/node.jpg'*/),
        name: 'Node.js',
        type: 'server'
    },
    desktop: {
        logo: require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/desktop.png'/*'./logos/desktop.png'*/),
        name: 'Desktop Browsers',
        type: 'average'
    },
    mobile: {
        logo: require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/mobile.png'/*'./logos/mobile.png'*/),
        name: 'Mobile Browsers',
        type: 'average'
    },
    firefox: {
        logo: require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/firefox.png'/*'./logos/firefox.png'*/),
        name: 'Firefox',
        type: 'desktop'
    },
    safari: {
        logo: require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/safari.png'/*'./logos/safari.png'*/),
        name: 'Safari',
        type: 'desktop'
    },
    chrome: {
        logo: require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/chrome.png'/*'./logos/chrome.png'*/),
        name: 'Chrome',
        type: 'desktop'
    },
    edge: {
    ...
    ios: {
        logo: require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/safari-ios.png'/*'./logos/safari-ios.png'*/),
        name: 'iOS Safari',
        type: 'mobile'
    },
    android: {
        logo: require.resolve('/markojs-website$1.0.0/routes/index/components/benchmarks/logos/chrome-android.png'/*'./logos/chrome-android.png'*/),
