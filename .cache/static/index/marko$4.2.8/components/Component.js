$_mod.def("/marko$4.2.8/components/Component", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var domInsert = require('/marko$4.2.8/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var marko = require('/marko$4.2.8/runtime/index'/*'../'*/);
...
var RenderResult = require('/marko$4.2.8/runtime/RenderResult'/*'../runtime/RenderResult'*/);
...
var updateManager = require('/marko$4.2.8/components/update-manager'/*'./update-manager'*/);
var morphdom = require('/marko$4.2.8/morphdom/index'/*'../morphdom'*/);
var eventDelegation = require('/marko$4.2.8/components/event-delegation'/*'./event-delegation'*/);
